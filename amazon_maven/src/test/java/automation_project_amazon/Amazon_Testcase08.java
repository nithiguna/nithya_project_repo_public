...
public class Amazon_Testcase08  extends Launch_Quit_Automation_Amazon {
	@Test(dataProvider = "Login", dataProviderClass=utility1.Data_For_Login.class)
	@Parameters("browser")
	public void sorting_price_etc(String username, String password) throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		a3.second_view_the_reviews();
		Thread.sleep(4000);
		a3.second_price_select();
		Thread.sleep(2000);
		log2.mouse_hover_account(driver);
		log2.sign_out();
}
