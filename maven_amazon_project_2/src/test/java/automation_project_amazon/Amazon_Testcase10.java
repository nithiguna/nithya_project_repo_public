...
public class Amazon_Testcase10 extends Launch_Quit_Automation_Amazon {
	...
	@Parameters("browser")
	public void verify_shopping_cart_update_delete_cart(String username, String password) throws EncryptedDocumentException, IOException, InterruptedException {
...
//		a4.switchwindow(driver);
		...
		a6.delete_cart();
		Thread.sleep(2000);
		a6.validate_deleting_cart();    //assert
		log2.mouse_hover_account(driver);
		log2.sign_out();
