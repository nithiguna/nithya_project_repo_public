...
public class Amazon_Testcase11 extends Launch_Quit_Automation_Amazon {
	...
	@Parameters("browser")
	public void entire_checkout_process(String username, String password) throws EncryptedDocumentException, IOException, InterruptedException {
		...
		//p1.use_this_pay();
		p1.use_payment();
		c1.review_cart_till_end();  //assert 
