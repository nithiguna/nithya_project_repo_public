//Assignment-5
//Test Case Id: Amz_Smoke_05
//Test Case Scenario: Login->searching->adding the product 
//to wishlist->adding the product to cart->reaching
//till payment option CC->logout
...
public class Amz_Smoke_05 extends Amz_Launch_Quit {

	@Test(dataProvider ="Login",dataProviderClass=utility.Fetching_Excel_Data.class)
	//@Parameters("browser")
	public void credit_card(String username,String password) throws EncryptedDocumentException,IOException {	//fetch excel
