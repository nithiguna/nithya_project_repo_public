//Assignment -7
//Amz_Smoke_07	Login->seraching->adding the product
//to wishlist->adding the product to cart->reaching
//till payment option UPI->logout
...
public class Amz_Smoke_07 extends Amz_Launch_Quit 
{

	@Test(dataProvider ="Login",dataProviderClass=utility.Fetching_Excel_Data.class)
	//@Parameters("browser")
	public void upi(String username,String password) throws EncryptedDocumentException,IOException {	//fetch excel
		...
		a1.pwd(password); 				
		a1.sign_in();
		Amz_Home01 a7 = new Amz_Home01(driver);
		...
		n1.navigate_back();
		Amz_Add_Card_Wishlist_Revert a2 = new Amz_Add_Card_Wishlist_Revert(driver);
		a2.add_cart();
